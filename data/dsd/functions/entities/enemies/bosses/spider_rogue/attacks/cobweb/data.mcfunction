...
summon snowball ^ ^1 ^-1 {Tags:["rc.boss.spider_rogue.cobweb","rc.boss.spider_rogue.cobweb.motion"],Small:1b,Invisible:1b,Silent:1b,Invulnerable:1b,DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:cobweb",Count:1b}]}
